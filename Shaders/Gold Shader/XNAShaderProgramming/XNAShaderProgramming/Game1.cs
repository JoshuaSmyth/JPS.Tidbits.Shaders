...
namespace XNAShaderProgramming
{
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            projection = Matrix.CreatePerspectiveFieldOfView(fov*1.25f, aspectRatio, 0.1f, 1000.0f);

             diffuseTexture = Content.Load<Texture2D>("model_diff");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            ambientLightColor = Color.Gold.ToVector4();
